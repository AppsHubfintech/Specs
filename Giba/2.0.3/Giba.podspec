...
Alamofire+ObjectMapper network library for Swift 4
  ...
  s.license          = 'MIT'
  s.author           = { "Felipe Cardoso" => "felipe.cardoso@hubfintech.com.br", "Guilherme Silva" => "guilherme.silva@hubfintech.com.br", "João Paulo Cavalcante dos Anjos" => "joao.anjos@hubfintech.com.br" }
